\documentclass[11pt,a4paper,uplatex,nomag,dvipdfmx]{jsarticle}
...
%========== Templates ==========
\newcommand{\arXiv}[4]{\acitem #1, ``#2'', \frenchspacing\href{https://arxiv.org/abs/#3}{arXiv:#3} (#4).\nonfrenchspacing}
% \newcommand{\arXiv}[4]{\textbf{``#2''}\\#1\\\frenchspacing\href{https://arxiv.org/abs/#3}{arXiv:#3} (#4).\nonfrenchspacing}
% Usage: \arXiv{Authors}{Title}{Identifier}{Year}

\newcommand{\publication}[6]{\acitem #1, ``#2'', \frenchspacing\href{https://doi.org/#4}{#3 (#5)}. [\href{https://arxiv.org/abs/#6}{arXiv:#6}]\nonfrenchspacing}
...
\newcommand{\ConferenceJP}[7]{\acitem「#2」（#7）、#3、#4、#6}
\newcommand{\ConferenceEN}[7]{\acitem ``#2'' (#7), #3, #4, #6.}

\newcommand{\ifempty}[2]{\if\relax\detokenize{#1}\relax\else#1#2\fi}

\newcommand{\SeminarJP}[7]{\acitem「#2」\ifempty{#3}{、}#4、#6}
\newcommand{\SeminarEN}[7]{\acitem ``#2'', \ifempty{#3}{, }#4, #6.}


% \makeatletter
% \newcommand{\ConferenceJP}{\@ifstar{\ConferenceJP@star}{\ConferenceJP@nostar}}
% \newcommand{\ConferenceEN}{\@ifstar{\ConferenceEN@star}{\ConferenceEN@nostar}}
% \newcommand{\ConferenceJP@star}[7]{\acitem「#2」（#7）、#3、#4、#6}
% \newcommand{\ConferenceEN@star}[7]{\acitem``#2'' (#7), #3, #4, #6.}
% \newcommand{\ConferenceJP@nostar}[7]{\ifwebpage\acitem「#2」（#7）、#3、#4、#6\fi}
% \newcommand{\ConferenceEN@nostar}[7]{\ifwebpage\acitem ``#2'' (#7), #3, #4, #6.\fi}
% \makeatother
...
\newlength{\acindent}
\setlength{\acindent}{1.6em}
\newlength{\acindentsep}
\setlength{\acindentsep}{0.6em}
\newcounter{aclisting}
\newcommand{\acitem}{\setlength{\hangindent}{\acindent}\stepcounter{aclisting}\makebox[\acindent][r]{\arabic{aclisting}.\hspace{\acindentsep}}}
...
\newcounter{issubmission}
% \setcounter{issubmission}{0} % Webpage
\setcounter{issubmission}{1} % Submission

\newcommand{\ifsubmission}{\ifodd\value{issubmission}}
\newcommand{\ifwebpage}{\ifodd\value{issubmission}\relax\else}
...
\normalsize JSPS Postdoctoral Fellow, Department of Physics, Kyoto University
...
% \je
% {京都大学大学院 理学研究科 物理学・宇宙物理学専攻 特定研究員（学振PD）。非平衡熱力学の理論を研究しています。}
% {Postdoctoral researcher at the Department of Physics, Graduate School of Science, Kyoto University. I study the theoretical aspects of nonequilibrium thermodynamics.}
% \par
% }
...
\hspace{3em}
\makebox[22em][l]{Email:
% \href{mailto:naruo.ohga@ubi.s.u-tokyo.ac.jp}{naruo.ohga@ubi.s.u-tokyo.ac.jp} \\
\href{mailto:ohga.naruo.7p@kyoto-u.ac.jp}{ohga.naruo.7p@kyoto-u.ac.jp}}%
Google Scholar:
\je{\href{https://scholar.google.com/citations?user=jOdc58QAAAAJ&hl=ja}{Naruo Ohga}}{\href{https://scholar.google.com/citations?user=jOdc58QAAAAJ}{Naruo Ohga}} \\
\hspace{3em}
\makebox[22em][l]
{Webpage:
...
\section{\je{研究キーワード}{Research Profile}}
\je
{非平衡熱力学（ゆらぎの熱力学、化学熱力学、量子熱力学）、確率過程、情報理論}
{Theoretical physicist working on the nonequilibrium thermodynamics of stochastic, chemical, and quantum systems. Particularly interested in uncovering universal laws and building frameworks, such as thermodynamic bounds/inference, eigenvalue bounds, and control methods, using mathematical techniques from stochastic processes, information theory, and various inequalities.}
% {Nonequilibrium thermodynamics, Stochastic thermodynamics, Stochastic processes, Information theory}


\ifwebpage
\section{\je{職歴}{Academic Appointments}}
\fi 

\ifsubmission
\section{\je{研究履歴}{Research Appointments}}

\subsection{\je{ポジション}{Academic positions}}
\fi 

\je
{2026年4月〜現在 --- \textbf{京都大学} 理学研究科 物理学・宇宙物理学専攻\\
特定研究員（学振PD） （受入研究者：金澤輝代士）}
{Apr.~2026--Present --- Department of Physics, \textbf{Kyoto University} (Kyoto, Japan)\\
JSPS Postdoctoral Fellow (Host: Prof.~Kiyoshi Kanazawa)}\\
Research on universal properties of the timescales of nonequilibrium systems
% JSPS Postdoctoral Fellow / Program-Specific Researcher (Host: Prof.~Kiyoshi Kanazawa)}

\ifsubmission

\subsection{\je{滞在研究}{Short-term research experiences}}

Jan.~2024--Mar.~2024 --- NTT Basic Research Laboratories (Kanagawa, Japan)\\
Research Intern (Host: Dr.~Takuya Hatomura)

\fi


\section{\je{学歴}{Education}}


\je
{2023年4月〜2026年3月 --- \textbf{東京大学大学院} 理学系研究科 物理学専攻\\
2026年3月24日：\textbf{博士（理学）} （指導教員：伊藤創祐）\\
...
［理学系研究科 研究奨励賞］}
% {Apr.~2023--Mar.~2026 --- \textbf{The University of Tokyo} (Tokyo, Japan)\\
% Doctoral Program, Department of Physics, Graduate School of Science\\
% Supervisor: Prof.~Sosuke Ito\\
% Degree Title: \textbf{Doctor of Philosophy} (Mar.~24, 2026)\\
% Thesis: ``Rigorous and universal nonequilibrium statistical physics of two-time correlations in Markov jump systems''\\{}%
% [The School of Science Encouragement Award (Doctoral program)]}
{Apr.~2023--Mar.~2026 --- Department of Physics, \textbf{The University of Tokyo} (Tokyo, Japan)\\
Mar.~24, 2026:  \textbf{Ph.D. in Physics} (Supervisor: Prof.~Sosuke Ito)\\
Dissertation: ``Rigorous and universal nonequilibrium statistical physics of two-time correlations in Markov jump systems''\\{}%
\textit{The School of Science Encouragement Award (Doctoral program)}}

\je
{2021年4月〜2023年3月 --- \textbf{東京大学大学院} 理学系研究科 物理学専攻\\
2023年3月23日：\textbf{修士（理学）} （指導教員：伊藤創祐）\\
学位論文：「非平衡熱力学における情報幾何学の大域的構造とその応用」}
% {Apr.~2021--Mar.~2023 --- \textbf{The University of Tokyo} (Tokyo, Japan)\\
% Master's Program, Department of Physics, Graduate School of Science\\
% Supervisor: Prof.~Sosuke Ito\\
% Degree Title: \textbf{Master of Science} (Mar.~23, 2023)\\
% Thesis: ``Global structure in information geometry for nonequilibrium thermodynamics and its applications''}
{Apr.~2021--Mar.~2023 --- Department of Physics, \textbf{The University of Tokyo} (Tokyo, Japan)\\
Mar.~23, 2023: \textbf{M.Sc.~in Physics} (Supervisor: Prof.~Sosuke Ito)\\
Thesis: ``Global structure in information geometry for nonequilibrium thermodynamics and its applications''}

\je
{2017年4月〜2021年3月 --- \textbf{東京大学} 理学部 物理学科\\
2021年3月18日：\textbf{学士（理学）} \\{}
［理学部 学修奨励賞］}
% {Apr.~2017--Mar.~2021 --- \textbf{The University of Tokyo} (Tokyo, Japan)\\
% Bachelor's Program, Department of Physics, Faculty of Science\\
% Degree Title: \textbf{Bachelor of Science} (Mar.~18, 2021)\\{}%
% [The School of Science Encouragement Award (Undergraduate Program)]}
{Apr.~2017--Mar.~2021 --- Department of Physics, \textbf{The University of Tokyo} (Tokyo, Japan)\\
Mar.~18, 2021: \textbf{B.Sc.~in Physics}\\{}%
\textit{The School of Science Encouragement Award (Undergraduate Program)}}


\section{\je{論文}{Publications}}


\subsection{\je{出版論文}{Peer-Reviewed Publications}}
...
{Phys. Rev. Research \textbf{8}, 013039}
{10.1103/x2dm-9p8m}
{2026}
{2501.01151}
...
{2023}
{2303.13116}
\\\textit{Editors' Suggestion; Highlighted in \href{https://physics.aps.org/articles/v16/142}{Physics Magazine Viewpoint}; \href{https://info.aps.org/webmail/640833/1133199511/4cd193474ddc5607815b7d92d183ecaec68e367faf8818a002676ea3c3eeed44}{Most-downloaded PRL paper} in statistical physics published in 2023}%
\ifwebpage;
\je{[プレスリリース（\href{https://www.s.u-tokyo.ac.jp/ja/press/2023/8610/}{日本語}/\href{https://www.s.u-tokyo.ac.jp/en/press/2023/8524/}{英語}）]}
{\textit{Press Release (\href{https://www.s.u-tokyo.ac.jp/en/press/2023/8524/}{en}/\href{https://www.s.u-tokyo.ac.jp/ja/press/2023/8610/}{ja})}}
\fi
...
\section{\je{受賞・採用}{Fellowships \& Awards}}

%!!!!!
%受賞にはタイトルを付すのが正式らしい。Research mapを参照。
%!!!!!

\subsection{\je{採用・資金}{Competitive fellowships and funding}}
...
--- 
\je
{日本学術振興会 \href{https://www.jsps.go.jp/j-pd/index.html}{特別研究員（PD）}}
{\href{https://www.jsps.go.jp/english/e-pd/index.html}{Research Fellowship for Young Scientists (PD)}, Japan Society for the Promotion of Science (JSPS).}
...
--- 
\je
{日本学術振興会 \href{https://www.jsps.go.jp/j-pd/index.html}{特別研究員（DC1）}}
{\href{https://www.jsps.go.jp/english/e-pd/index.html}{Research Fellowship for Young Scientists (DC1)}, Japan Society for the Promotion of Science (JSPS).}
...
--- 
\je
{東京大学国際卓越大学院教育プログラム（WINGS）「\href{https://www.s.u-tokyo.ac.jp/ja/FoPM/}{変革を駆動する先端物理・数学プログラム（FoPM）}」}
{\href{https://www.s.u-tokyo.ac.jp/en/FoPM/}{Forefront Physics and Mathematics Program to Drive Transformation (FoPM)}, a World-leading Innovative Graduate Study (WINGS) Program, The University of Tokyo.}



\subsection{\je{受賞}{Honors and awards}}
...
---
\je
{東京大学理学系研究科 \href{https://www.phys.s.u-tokyo.ac.jp/award/48927/}{研究奨励賞}}
{\href{https://www.phys.s.u-tokyo.ac.jp/award/48927/}{The School of Science Encouragement Award (Doctoral program)}, Graduate School of Science, The University of Tokyo}
...
---
\je
{新学術領域研究「情報物理学でひもとく生命の秩序と設計原理」\href{https://infophys-bio.jp/award}{第4回研究賞}}
...
---
\je
{新学術領域研究「情報物理学でひもとく生命の秩序と設計原理」\href{https://infophys-bio.jp/archives/1035}{第7回領域会議 発表賞}}
...
---
\je
{Physical Review Letters誌~ \href{https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.131.077101}
{Editors' Suggestion}}{\href{https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.131.077101}{Editors' Suggestion}, Physical Review Letters}
...
---
\je
{東京大学理学部 \href{https://www.phys.s.u-tokyo.ac.jp/award/27300}{学修奨励賞}}
{\href{https://www.phys.s.u-tokyo.ac.jp/award/27300}{The School of Science Encouragement Award (Undergraduate Program)}, School of Science, The University of Tokyo}
...
\subsection{\je{セミナー}{Invited seminars}}


\je{
\SeminarJP
{\emph{大賀成朗}}
{Mpemba効果の確率過程による定式化と、単調性に基づくno-Mpemba定理}
{東北大学数学教室確率論セミナー}
{2026年7月10日}
{2026年7月10日}
{東北大学数学専攻、宮城}
...
\SeminarEN
{\emph{Naruo Ohga}}
{Formulation of the Mpemba effect with stochastic processes and the no-Mpemba theory based on monotonicity} %英語タイトル提出せず
{Tohoku Probability Seminar}
{Jul.~10, 2026}
{Jul.~10, 2026}
{Mathematical Institute, Tohoku University, Miyagi, Japan}
{Seminar}
}
...
{Jul.~14, 2022}
{Jul.~14, 2022}
{University of Washington and UNC-Chapel Hill, USA (Online)}
{Seminar}
...
\ConferenceEN
{\emph{Naruo Ohga}}
{Rigorous and universal approaches to Mpemba effects in classical stochastic systems}
{Frontiers in Nonequilibrium Physics 2026}
{May 11--14, 2026}
{May 11, 2026}
{Maskawa Hall, Kyoto University, Kyoto, Japan}
{Poster}
...
\je{
\ConferenceJP
{\emph{大賀成朗}、Jean-Charles Delvenne}
{局所的な脱出率と巻き数はマルコフ過程の固有値をどう決定するか}
{日本物理学会第81回年次大会}
{2026年9月14日〜17日}
{9月15日}
{東京大学 駒場キャンパス、東京}
...
\ConferenceEN
{\emph{Naruo Ohga}, Jean-Charles Delvenne}
{How the local escape rates and winding number shape the eigenvalues of Markov processes}
{81st Annual Meeting, The Physical Society of Japan}
{Sep.~14--17, 2026}
{Sep.~15}
...
\ConferenceEN
{\emph{Naruo Ohga}, Sosuke Ito}
{Information-geometric dual affine coordinates in non-equilibrium chemical thermodynamics}
...
\ConferenceEN
{\emph{Naruo Ohga}}
{A global structure of stochastic thermodynamics based on dually flat geometry}
{The 66th Condensed Matter Physics Summer School}
{Aug.~2--5, 2021}
{Aug.~3}
{Japan (Online)}
{Oral}
...
\je{2021年秋学期}{Autumn 2021} --- 
\je{「非平衡科学」ティーチングアシスタント (TA) }{Teaching assistant of ``Non-equilibrium Physics'' (Prof.~Sosuke Ito), the University of Tokyo}
\fi


\ifsubmission
\section{\je{教育}{Teaching \& Research Mentoring}}

\subsection{\je{ティーチングアシスタント (TA)}{Teaching assistant}}

\je{2021年秋学期}{Autumn 2021} --- 
\je{「非平衡科学」ティーチングアシスタント (TA) }{``Non-equilibrium Physics'' (Prof.~Sosuke Ito), the University of Tokyo}
% Assisted with online streaming and assignment preparation

\subsection{\je{メンター}{Research Mentoring}}

Informally mentored junior researchers in stochastic and quantum thermodynamics, advising on research design, analytical calculations, data analysis, and manuscript preparation.

Jan.~2025--present --- Ruicheng Bao (The University of Tokyo); resulted in a joint preprint

Apr.~2024--present --- Ayano Oda (The University of Tokyo)

Mar.~2024--Jul.~2026 --- Xin-Hai Tong (The University of Tokyo); resulted in a joint preprint

Jun.~2024--Jan.~2026 --- Xin Wang (The University of Tokyo); resulted in a publication
...
{Analytical methods: Stochastic processes, Inequalities, Information theory}\\
\je{プログラミング：}{Programming: }Python (NumPy, SymPy, Matplotlib, pandas), Modern C++\\
\je{ソフトウェア／ツール：}{Software \& Tools: }\LaTeX, Adobe Illustrator
