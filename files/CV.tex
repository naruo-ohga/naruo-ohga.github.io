...
% Usage: \publication{Authors}{Title}{Bibliography}{doi}{Year}{ArXivIdentifier}



% \newcommand{\ConferenceJP}[7]{#1\\「#2」（#7）\\#3、#4、#6}
% \newcommand{\ConferenceEN}[7]{#1\\``#2'' (#7)\\#3, #4, #6.}
\newcommand{\ConferenceJP}[7]{\acitem\hspace{-0.4zw}「#2」（#7）、#3、#4、#6}
\newcommand{\ConferenceEN}[7]{\acitem ``#2'' (#7), #3, #4, #6.}

\newcommand{\ifempty}[2]{\if\relax\detokenize{#1}\relax\else#1#2\fi}

\newcommand{\SeminarJP}[7]{\acitem\hspace{-0.4zw}「#2」\ifempty{#3}{、}#4、#6}
...
\subsection{\je{ポジション}{Academic position}} %positions
\fi 
...
\subsection{\je{滞在研究}{Short-term research experience}}
...
{2023}
{2303.13116}
\\\textit{Editors' Suggestion; Featured in \href{https://physics.aps.org/articles/v16/142}{a Viewpoint in Physics Magazine}; \href{https://info.aps.org/webmail/640833/1133199511/4cd193474ddc5607815b7d92d183ecaec68e367faf8818a002676ea3c3eeed44}{Most downloaded PRL paper} in statistical physics published in 2023}%
\ifwebpage;
...
{Analytical methods: Stochastic processes, Inequalities, Matrix theory, Information theory}\\
